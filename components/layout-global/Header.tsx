...
const Header: React.FC<HeaderProps> = ({ onToggleSidebar }) => {
  ...
  return (
    <header className="sticky top-0 z-20 ml-64 w-[calc(100%-16rem)] h-[60px] bg-white border-b border-gray-200 flex items-center px-4 md:px-6">
      <button
      ...
      <div className="flex items-center gap-4">
        <div className="relative">
          <label htmlFor="lang2" className="sr-only">Language</label>
          <select
            id="lang2"
            className="appearance-none bg-white border border-gray-300 text-sm rounded-md pl-3 pr-8 py-2 focus:outline-none focus:ring-2 focus:ring-purple-700 focus:border-purple-700"
            value={language}
